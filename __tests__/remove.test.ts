import { Chess, Square, QUEEN, WHITE, KNIGHT, BISHOP, BLACK } from '../src/chess'
...
test('remove - removing white pawn clears en passant square', () => {
  const chess = new Chess('rnbqkbnr/pppppp1p/8/8/3PPPp1/8/PPP3PP/RNBQKBNR b KQkq f3 0 3')
...
test('remove - removing black pawn clears white en passant square 2', () => {
  const chess = new Chess('rnbqkbnr/p1pppppp/8/8/1pPPP3/8/PP3PPP/RNBQKBNR b KQkq c3 0 3')
...
test('remove - removing black pawn clears en passant square', () => {
  const chess = new Chess('rnbqkbnr/pppp2pp/8/4ppP1/8/8/PPPPPP1P/RNBQKBNR w KQkq f6 0 3')
...
test('remove - removing white pawn clears black en passant square 2', () => {
  const chess = new Chess('rnbqkbnr/pp2pppp/8/1Ppp4/8/8/P1PPPPPP/RNBQKBNR w KQkq c6 0 3')
